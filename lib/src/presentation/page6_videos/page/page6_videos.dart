...
class Page6Videos extends StatefulWidget {
  const Page6Videos({super.key});

  @override
  State<Page6Videos> createState() => _Page6VideosState();
}

class _Page6VideosState extends State<Page6Videos> {
  ...
  //                   GetPage6Videos(link: Constants.sixthVideosLink ),
  //                 );
  //               },
              ...
              child: BlocBuilder<VideosBloc, VideosState>(
                builder: (context, state) {
                  if (state.status == Status.success) {
                    ...
                    final videos = filteredVideos ?? state.page6Videos;
                    ...
                    return Center(
                      child: MyErrorWidget(
                        onRetry: () {
                          context.read<VideosBloc>().add(
                            GetPage1Videos(link: Constants.sixthVideosLink),
                          );
                        },
                        errorMsg: state.failure?.errorMsg ?? "",
                      ),
