...
class Page4Videos extends StatefulWidget {
  const Page4Videos({super.key});

  @override
  State<Page4Videos> createState() => _Page4VideosState();
}

class _Page4VideosState extends State<Page4Videos> {
  ...
  //                   GetPage4Videos(link: Constants.fourthVideosLink),
  //                 );
  //               },
              ...
              child: BlocBuilder<VideosBloc, VideosState>(
                builder: (context, state) {
                  if (state.status == Status.success) {
                    ...
                    final videos = filteredVideos ?? state.page4Videos;
                    ...
                    return Center(
                      child: MyErrorWidget(
                        onRetry: () {
                          context.read<VideosBloc>().add(
                            GetPage1Videos(link: Constants.fourthVideosLink),
                          );
                        },
                        errorMsg: state.failure?.errorMsg ?? "",
                      ),
