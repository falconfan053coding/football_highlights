...
class Page3Videos extends StatefulWidget {
  const Page3Videos({super.key});

  @override
  State<Page3Videos> createState() => _Page3VideosState();
}

class _Page3VideosState extends State<Page3Videos> {
  ...
  //                   GetPage3Videos(link: Constants.thirdVideosLink),
  //                 );
  //               },
              ...
              child: BlocBuilder<VideosBloc, VideosState>(
                builder: (context, state) {
                  if (state.status == Status.success) {
                    ...
                    final videos = filteredVideos ?? state.page3Videos;
                    ...
                    return Center(
                      child: MyErrorWidget(
                        onRetry: () {
                          context.read<VideosBloc>().add(
                            GetPage1Videos(link: Constants.thirdVideosLink),
                          );
                        },
                        errorMsg: state.failure?.errorMsg ?? "",
                      ),
