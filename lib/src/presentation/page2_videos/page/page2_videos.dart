...
class Page2Videos extends StatefulWidget {
  const Page2Videos({super.key});

  @override
  State<Page2Videos> createState() => _Page2VideosState();
}

class _Page2VideosState extends State<Page2Videos> {
  ...
  //                   GetPage2Videos(link: Constants.secondVideosLink),
  //                 );
  //               },
              ...
              child: BlocBuilder<VideosBloc, VideosState>(
                builder: (context, state) {
                  if (state.status == Status.success) {
                    ...
                    final videos = filteredVideos ?? state.page2Videos;
                    ...
                    return Center(
                      child: MyErrorWidget(
                        onRetry: () {
                          context.read<VideosBloc>().add(
                            GetPage1Videos(link: Constants.secondVideosLink),
                          );
                        },
                        errorMsg: state.failure?.errorMsg ?? "",
                      ),
