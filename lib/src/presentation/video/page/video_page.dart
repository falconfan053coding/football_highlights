...
import 'package:football_highlights/app/router.dart';
...
//       }
//
//       // Video pozitsiyasini saqlab qolish
...
//   //                         children: [
//   //                           Text(
//   //                             widget.videos?[_currentPlayingIndex!].Channelname?.toString() ?? "No channel",
...
//   //                                 ? formatDate(
//   //                               widget.videos?[_currentPlayingIndex!].Upload_date ?? DateTime.now(),
//   //                             )
//   //                                 : "No date",
//   //                             style: const TextStyle(
//   //                               fontSize: 14,
...
class _VideoPageState extends State<VideoPage> {
  ...
  void initState() {
    ...
    _youtubeController.addListener(() {
      ...
      if (position > duration * 0.992 && !_hasPlayedNext) {
        setState(() {
          _hasPlayedNext = true;
        });
        _playNextVideo();
  ...
  @override
  Widget build(BuildContext context) {
    final horizontalHeight = MediaQuery.of(context).size.height * 0.108;
    final fullScreenHeight = MediaQuery.of(context).size.height * 0.45;
                ...
                child: YoutubePlayerBuilder(
                  player: YoutubePlayer(
                    ...
                    topActions: [
                      ...
                      Padding(
                        padding: EdgeInsets.only(top: _isFullScreen ? fullScreenHeight : horizontalHeight),
